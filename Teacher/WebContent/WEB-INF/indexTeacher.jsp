		...
		<table id="table_id" align="center" border="1">
			...
			<c:forEach items="${teachers}" var="teacher">
				<tr>
					...
					<td id="${teacher.id}">${teacher.birthday}</td>
				</tr>
			</c:forEach>
		</table>
	</div>
...
<div id="add_comm" class="teaall" align="center">
	...
	<form action="queryByName" method="post">
		<input type="text" placeholder="氏名" name="teachername">
...
<div id="add_comm" class="teaall" align="center">
	...
	<div id="add_comm" class="teaall" align="center">
		...
		<form id="addForm" action="addTea" method="post">
			<input id="addteachername" type="text" placeholder="氏名" name="teachername" />
...
<div id="edit_comm" class="teaupdate" align="center">
	...
	<form id="editForm" action="update" method="post">
	    ...
	    <input id="editbirthday" type="text" placeholder="birthday" name="birthday" />
